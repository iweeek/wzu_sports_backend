	...
	public List<SportsCourse> dealSportsCourse(File file, Long universityId, String schoolYear, String term) {
		...
		try {
			...
			for (int i = 1; i<sheet.getRows();i++) {
				...
				if (term.equals("第一学期")) {
					sportsCourse.setTerm( (short) 1);
					sportsCourse.setYear(schoolYear.substring(0, 4));
				} else {
					sportsCourse.setTerm( (short) 2);
	...
	public List<PhysicalTest> dealPhysicalTest(File file,Long universityId,String schoolYear,String term) {
		...
		try {
			...
			for (int i = 1; i<sheet.getRows(); i++) {
				...
				if (term.equals("第一学期")) {
					physicalTest.setTerm( (short) 1);
					physicalTest.setYear(schoolYear.substring(0, 4));
				} else {
					physicalTest.setTerm( (short) 2);
				...
				physicalTest.setTotalScore(new BigDecimal(cel.get(7)));
				physicalTest.setTotalScoreGrade(cel.get(8));
				cel.set(9, testIsNull(cel.get(9)));
				physicalTest.setHeight(new BigDecimal(cel.get(9)));
				cel.set(10, testIsNull(cel.get(10)));
				physicalTest.setWeight(new BigDecimal(cel.get(10)));
				...
				physicalTest.setStandingLongJump((int)new Integer(cel.get(12)));
				cel.set(13, testIsNull(cel.get(13)));
				physicalTest.setSitAndReach(new BigDecimal(cel.get(13)));
				cel.set(14, testNotDouble(cel.get(14)));
				physicalTest.setOneMinuteSitUp((short)new Short(cel.get(14)));
				cel.set(15, testNotDouble(cel.get(15)));
				physicalTest.setPullUp((short)new Short(cel.get(15)));
				cel.set(16, testIsNull(cel.get(16)));
				physicalTest.setFiftyRunTime(new BigDecimal(cel.get(16)));
				cel.set(17, testIsNull(cel.get(17)));
				physicalTest.setEightHundredRunTime(new BigDecimal(cel.get(17)));
				cel.set(18, testIsNull(cel.get(18)));
				physicalTest.setOneThousandRunTime(new BigDecimal(cel.get(18)));
